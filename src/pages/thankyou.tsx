...
const ThankyouContent = () => {
  ...
  if (order.status === "pending") {
    return (
      <>
        ...
        <Heading textAlign="center">Waiting for a confimation</Heading>
        <Text textAlign="center">
          Your order has been placed. Please wait for confirmation from the
          restaurant
        </Text>
      </>
    );
  ...
  return (
    <>
      ...
      <Heading textAlign="center">Order Comfirmed</Heading>
      <Text textAlign="center">
        See you soon! Your order has been confirmed and will be ready for
        pickup.
      </Text>
    </>
  );
